...
//-- messaging 
chrome.runtime.sendMessage({method: "getUserData"}, function(usersettings) {  
      console.log('get user data response: ', usersettings);      
      _usersettings =  undefined ===  usersettings.status ?  {  isActive: false } : usersettings.status.data;
});

chrome.runtime.onMessage.addListener(function(request, sender, sendResponse) {       
      console.log('New message  recived !!! ', request.data.active);      
      _usersettings.active = request.data.active; // update only active property
      //_usersettings.active = request.data;
});
